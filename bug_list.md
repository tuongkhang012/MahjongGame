...
4. Giải quyết kết thúc ván sau khi kêu Tsumo hoặc Ron
5. Tổng điểm cho player (cơ chế cộng và trừ điểm)
6. Gió bàn (Thể hiện gió bàn) + số tile còn lại (hiển thị ở center_board_field)
7. Hover được call field
8. Sửa hàm update relative và absolute position cho các field
9. Xử lý trường hợp cho Chankan (cướp từ Kakan)
10. Xử lý trường hợp vẫn có thể call ankan trong khi đang riichi
11. In log
12. ~~Sau khi riichi, nếu player bốc lên lá không thể hoàn thành được riichi thì sẽ phải discard chính lá đó~~ (DONE)
13. **Hòa nếu như có 4 Kan**
